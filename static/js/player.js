...
// Function to create language selection dropdown
...
// 	});
// 	player.insertBefore(dropdown, video);
//   }
  
//   // Function to create search input and button
...
// 	player.insertBefore(searchContainer, video);
//   }
function createLanguageDropdown(languages) {
    const dropdown = document.createElement('select');
    dropdown.id = 'language-select';
